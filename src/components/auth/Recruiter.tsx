...
const Recruiter = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const registration = await recruiterRegistration(recruiterForm);
      if (registration == 200) {
      ...
      <form className="flex flex-col gap-4 text-start" onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleChangeRecruiterForm}
            required
        ...
        {/** Company Name */}
        <div className="relative">
          <i className="ri-building-line absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"></i>
          <input
            type="text"
            name="companyName"
