            ...
            <div className="flex min-h-17 items-center justify-between gap-4 px-4 sm:px-6">
                ...
                <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex min-w-0 items-center gap-3">
                        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-indigo-500 to-indigo-700 text-xs font-semibold text-white shadow-sm">
                            {initials}
                        </div>
