const ExpandedApplicationDetails = ({ application }: { application: any }) => (
  <div className="border-t border-slate-100 bg-slate-50 p-5">
    <div className="grid md:grid-cols-2 gap-6">
      <div>
        ...
        <div className="space-y-1.5 text-sm text-slate-600">
          ...
          <p>
            <span className="font-medium text-slate-700">Application ID:</span> {application._id}
          </p>
          <p>
    ...
    <div className="mt-6 pt-5 border-t border-slate-200">
      ...
      <p className="text-sm text-slate-600 leading-relaxed whitespace-pre-wrap bg-white border border-slate-200 rounded-lg p-4">
